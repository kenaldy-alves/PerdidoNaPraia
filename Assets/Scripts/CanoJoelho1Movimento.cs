...
public class CanoJoelho1Movimento : MonoBehaviour {
    public bool verificadorCanoJoelho1 = false; //variavel de controle do puzzle
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (gameObject.transform.rotation.eulerAngles.z.Equals(270)) //verifica se esta na posiçao correta
            verificadorCanoJoelho1 = true;
        else
            verificadorCanoJoelho1 = false;
